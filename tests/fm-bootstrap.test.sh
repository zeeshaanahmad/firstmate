...
declared quota_scope is accepted^{"rules":[{"when":"agy work","use":[{"harness":"agy","model":"claude-opus-4-6-thinking","quota_scope":"claude_gpt"},{"harness":"agy","model":"gemini-3-pro","quota_scope":"gemini"}]}],"default":{"harness":"agy","quota_scope":"gemini"}}^empty^
empty profile quota_scope is flagged^{"rules":[{"when":"agy work","use":{"harness":"agy","quota_scope":""}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - profile quota_scope must be a non-empty string without surrounding whitespace when present
leading whitespace profile quota_scope is flagged^{"rules":[{"when":"agy work","use":[{"harness":"agy","quota_scope":" gemini"}]}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - profile quota_scope must be a non-empty string without surrounding whitespace when present
trailing newline profile quota_scope is flagged^{"rules":[{"when":"agy work","use":{"harness":"agy","quota_scope":"gemini\n"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - profile quota_scope must be a non-empty string without surrounding whitespace when present
non-string profile quota_scope is flagged^{"rules":[{"when":"agy work","use":{"harness":"agy","quota_scope":5}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - profile quota_scope must be a non-empty string without surrounding whitespace when present
default profile empty quota_scope is flagged^{"default":{"harness":"agy","quota_scope":""}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - profile quota_scope must be a non-empty string without surrounding whitespace when present
default array profile whitespace quota_scope is flagged^{"default":[{"harness":"claude"},{"harness":"agy","quota_scope":"gemini "}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - profile quota_scope must be a non-empty string without surrounding whitespace when present
default profile non-string quota_scope is flagged^{"default":{"harness":"agy","quota_scope":["gemini"]}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - profile quota_scope must be a non-empty string without surrounding whitespace when present
