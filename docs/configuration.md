...
FM_CREW_STATE_NM_TIMEOUT=10   # seconds allowed per no-mistakes query inside fm-crew-state.sh; hitting it reports unknown with the timeout as the reason, never a state guessed from the status log
