...
| `fm-pr-merge.sh`         | Record PR metadata, guard the merge result against the current default branch, then merge a task's canonical full GitHub URL ([merge-time-static-guard.md](merge-time-static-guard.md)) |
