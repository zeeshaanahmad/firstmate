...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-brief-evidence-home.4MJn4V/state/evidence-scout.status'`
...
# Definition of done
Write your findings to `/tmp/fm-brief-evidence-home.4MJn4V/data/evidence-scout/report.md`. The report must stand alone:
...
Before reporting done, read and follow `/Users/muhammadzahmed/.no-mistakes/worktrees/c3eda0adcf59/01M090YF5PGPHJCK8QWXKZ98YX/.agents/skills/decision-hold-lifecycle/SKILL.md` and pass its shared completion gate for the report and any visual review.
