...
4. Report status by appending one line:
   ...
   Whatever the wait, append it at the MOMENT you park: starting a gate or a full test run and waiting
   for it, waiting on a validation pipeline step, or any other wait you expect to clear without
   firstmate doing anything. Append a \`working: ...\` line when it resumes.
